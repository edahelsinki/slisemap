...
SLISEMAP is implemented in *Python* using *PyTorch* for efficient optimisation, and optional GPU-acceleration. For more information see the [full paper], the [demo paper], the [demonstration video] ([slides]), the [![binder badge]][binder demo] and the corresponding [examples directory], or the [documentation].
...
[full paper]: https://arxiv.org/abs/2201.04455
[demo paper]: https://github.com/edahelsinki/slisemap/blob/main/examples/demo_paper.pdf

[demonstration video]: https://youtu.be/xp4LTysr8PA
[slides]: https://github.com/edahelsinki/slisemap/blob/main/examples/slisemap_demo_paper.pptx
...
[binder demo]: https://mybinder.org/v2/gh/edahelsinki/slisemap/HEAD?labpath=examples%2F01_regression_example_autompg.ipynb

[examples directory]: https://github.com/edahelsinki/slisemap/tree/main/examples
